...
(function (ReplayerEvents) {
    ...
    ReplayerEvents["Input"] = "input";
    ReplayerEvents["MetaChange"] = "meta-change";
    ...
    Replayer.prototype.getCastFn = function (event, isSync) {
        ...
        switch (event.type) {
            ...
            case exports.EventType.Meta:
                castFn = function () {
                    _this.emitter.emit(exports.ReplayerEvents.MetaChange, {
    ...
    Replayer.prototype.applyIncremental = function (e, isSync) {
        ...
        switch (d.source) {
            ...
            case exports.IncrementalSource.Input: {
                ...
                this.emitter.emit(exports.ReplayerEvents.Input, {
                    target: target,
                    data: d,
                });
                try {
